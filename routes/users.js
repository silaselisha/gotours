...
const {getUser, getUsers, updateUser, deleteUser, forgortPassword, resetPassword, updatePassword, updateUsersData, deleteAccount, myAccount, logout} = require('../controllers/users-handler');
